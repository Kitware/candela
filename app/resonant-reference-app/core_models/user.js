...
var Backbone = require('backbone'),
    Toolchain = require('./toolchain.js');

var Toolchains = Backbone.Collection.extend({
    initialize : function () {
...
var User = Backbone.Model.extend({
        ...
        */
        tools : {
            'singleDatasetView' : {
                ...
                model : 'datasets',
                view : require('../tools/SingleDatasetView/SingleDatasetView.js'),
                hidden : false,
                new : false
            },
            'singleVisualizationView' : {
                ...
                view : require('../tools/SingleVisualizationView/SingleVisualizationView.js'),
                hidden : false,
                new : false
            }
        },
    ...
    getCurrentToolchain : function () {
        var self = this,
            currentChain = self.get('currentToolchain');
